...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        {"--spec-sched"},
        {"--no-spec-sched"},
        string_format("confidence-scheduled draft length for chained drafters (draft-mtp); "
                      "replaces the static p-min stop rule after warmup (default: %s)",
                      params.speculative.draft.sched ? "enabled" : "disabled"),
        [](common_params & params, bool value) {
            params.speculative.draft.sched = value;
        }
